            ...
            {extracted && !extracting && (
                <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        <div>
                            <p className="text-[10px] text-slate-600 uppercase font-bold mb-1">Student Name</p>
        ...
        <div className="max-w-6xl mx-auto py-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="lg:col-span-2 space-y-6">
                    ...
                    {/* ── Input Area ── */}
                    <div className={activeMode === 'id' ? "bg-yellow-400 border-4 border-black text-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] rounded-none" : "glass p-8"}>
                            ...
                            <AnimatePresence mode="wait">
                                ...
                                {activeMode === 'id' && (
                                    <motion.div key="id-mode" initial={{ opacity: 0, x: -16 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 16 }}>
                                        <h3 className="text-3xl font-black text-black uppercase tracking-tighter mb-2 flex items-center gap-3">
                                            <BadgeCheck className="text-black" size={28} /> Verify by ID, Name, or Code
                                        </h3>
                                        <p className="text-black font-bold uppercase text-sm max-w-xl mb-8 leading-relaxed">
                                        ...
                                        <form onSubmit={handleIdSubmit} className="space-y-6">
                                            <input className="w-full py-5 px-5 transition-all outline-none bg-white border-4 border-black text-black font-bold text-xl focus:ring-0 focus:outline-none focus:-translate-y-1 focus:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] rounded-none placeholder:text-black/50" placeholder="CERTIFICATE ID (e.g. IITB-2023-001)"
                                            ...
                                            <div className="flex items-center gap-4 py-2 opacity-80">
                                                ...
                                                <span className="text-[11px] text-black font-black uppercase tracking-widest">or search by name</span>
                                                <div className="flex-1 bg-black h-1" />
                                            </div>

                                            <input className="w-full py-5 px-5 transition-all outline-none bg-white border-4 border-black text-black font-bold text-xl focus:ring-0 focus:outline-none focus:-translate-y-1 focus:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] rounded-none placeholder:text-black/50" placeholder={`${user?.role === 'organization' ? 'Candidate' : 'Student'} full name (e.g. Rahul Sharma)`}
                                        ...
                                        {scannerDone && (
                                            <div className="mt-4 flex items-center gap-2 text-black text-xs font-bold">
